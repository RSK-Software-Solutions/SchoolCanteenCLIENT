...
import { UserPersonalData } from "./UserSettings";
import { UserSettingsContent } from "./content/UserSettingsContent";
import React from "react";

type UserPersonalSettingsOptionProps = {
  userSettingsData: UserPersonalData;
  setUserSettingsData: React.Dispatch<SetStateAction<UserPersonalData>>;
...
export const UserPersonalSettingsOption = ({
  ...
  setUserSettingsData,
  userSettings,
}: UserPersonalSettingsOptionProps) => {
  return (
          ...
          <div key={settings.key} className="mb-4">
            ...
            <div className="flex">
              <input
                ...
                value={userSettingsData[settings.key as keyof UserPersonalData]}
